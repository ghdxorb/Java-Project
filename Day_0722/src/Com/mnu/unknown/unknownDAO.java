...
public class unknownDAO {
	...
	//1. 메소드 생성(객체 생성 후 반환)
	public unknown getunknown(int sabun,String name, int gender,
			int grade, int time) {
		//Unknown unknown = new Unknown();
		//unknown.setSabun(sabun);
		unknown unknown = new unknown(sabun, name,gender,grade,time);
		return unknown;
	...
	public int weekPayProcess(unknown sa, int weekPay) {
		int pay = 0;//주간급여
